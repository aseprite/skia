...
[laf](https://github.com/aseprite/laf) use the **`aseprite-m121`** branch.
...
Just ignore it.)
    ...
    cd C:\deps
    git clone -b aseprite-m121 https://github.com/aseprite/skia.git
    cd skia
...
Download [Ninja tool](https://github.com/ninja-build/ninja/releases/download/v1.11.1/ninja-win.zip)
and uncompress it in the `C:\deps\skia` dir.
