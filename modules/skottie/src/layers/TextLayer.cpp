...
SkFontStyle FontStyle(const AnimationBuilder* abuilder, const char* style) {
    static constexpr std::tuple<const char*, SkFontStyle::Weight> gWeightMap[] = {
        std::make_tuple("regular"   , SkFontStyle::kNormal_Weight),
        std::make_tuple("medium"    , SkFontStyle::kMedium_Weight),
        std::make_tuple("bold"      , SkFontStyle::kBold_Weight),
        std::make_tuple("light"     , SkFontStyle::kLight_Weight),
        std::make_tuple("black"     , SkFontStyle::kBlack_Weight),
        std::make_tuple("thin"      , SkFontStyle::kThin_Weight),
        std::make_tuple("extra"     , SkFontStyle::kExtraBold_Weight),
        std::make_tuple("extrabold" , SkFontStyle::kExtraBold_Weight),
        std::make_tuple("extralight", SkFontStyle::kExtraLight_Weight),
        std::make_tuple("extrablack", SkFontStyle::kExtraBlack_Weight),
        std::make_tuple("semibold"  , SkFontStyle::kSemiBold_Weight),
        std::make_tuple("hairline"  , SkFontStyle::kThin_Weight),
        std::make_tuple("normal"    , SkFontStyle::kNormal_Weight),
        std::make_tuple("plain"     , SkFontStyle::kNormal_Weight),
        std::make_tuple("standard"  , SkFontStyle::kNormal_Weight),
        std::make_tuple("roman"     , SkFontStyle::kNormal_Weight),
        std::make_tuple("heavy"     , SkFontStyle::kBlack_Weight),
        std::make_tuple("demi"      , SkFontStyle::kSemiBold_Weight),
        std::make_tuple("demibold"  , SkFontStyle::kSemiBold_Weight),
        std::make_tuple("ultra"     , SkFontStyle::kExtraBold_Weight),
        std::make_tuple("ultrabold" , SkFontStyle::kExtraBold_Weight),
        std::make_tuple("ultrablack", SkFontStyle::kExtraBlack_Weight),
        std::make_tuple("ultraheavy", SkFontStyle::kExtraBlack_Weight),
        std::make_tuple("ultralight", SkFontStyle::kExtraLight_Weight),
    };
    static constexpr std::tuple<const char*, SkFontStyle::Slant> gSlantMap[] = {
        std::make_tuple("italic" , SkFontStyle::kItalic_Slant),
        std::make_tuple("oblique", SkFontStyle::kOblique_Slant),
    };
